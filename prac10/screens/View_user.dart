import 'package:prac10/model/User.dart'; import 'package:flutter/material.dart';

class ViewUser extends StatefulWidget { final User user;
...
class _ViewUserState extends State<ViewUser> { @override
...
style: TextStyle(
fontWeight: FontWeight.w600, color: Colors.blueGrey, fontSize: 20),
),
	const SizedBox(	
